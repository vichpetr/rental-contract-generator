-- v10_rpc_fix.sql
-- Fixes and ensures the update/create RPC functions exist with correct signatures
-- Run this in the SQL Editor to fix "Could not find function" errors

-- 1. Update Unit Function
...
-- This tells PostgREST to refresh its cache of functions immediately
